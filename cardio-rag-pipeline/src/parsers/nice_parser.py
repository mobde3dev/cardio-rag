"""
PDF extraction module for NICE3 (NG238) guideline.
...
def _detect_page_label(raw_text: str, pdf_page: int) -> Optional[str]:
    ...
    NICE guideline PDFs typically have 'Page X of Y' in the footer.
    Also checks for standalone numbers near top/bottom.
    """
    # Check for NICE-style "Page X of Y"
    m = _PAGE_LABEL_RE.search(raw_text)
    if m:
        return m.group(1)

    # Fallback: standalone number near top/bottom
