...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 sm:h-16 w-full items-center justify-between border-b border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md px-3 sm:px-6 safe-top transition-colors">
      {/* Brand & Title */}
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <Badge
                variant="medical"
                size="sm"
                className="hidden xs:inline-flex text-[10px] sm:text-[11px] py-0 px-1.5"
              >
                WHO 2021 & NICE
              </Badge>
            </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        ...
        {currentUser ? (
          ...
          <Button
            ...
            className="text-xs font-semibold border-medical-200 dark:border-medical-900 text-medical-700 dark:text-medical-300 px-2.5 sm:px-3"
          >
